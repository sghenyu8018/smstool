...
if __name__ == '__main__':
    ...
    async def main():
        ...
        try:
            # ============================================================
            # 暂时关闭：短信签名工单号查询和成功率查询
            # 用于测试新功能（资质工单查询）
            # ============================================================
            print("\n" + "="*60)
            print("注意：短信签名工单号查询和成功率查询已暂时关闭")
            print("用于测试新功能（资质工单查询）")
            print("="*60)
            ...
            # 临时变量，避免后续代码报错
            signature_result = {'success': False, 'error': '已暂时关闭'}
            multi_result = {'success': False, 'time_ranges': [], 'results': {}}
            ...
            print("\n现在可以测试新功能（资质工单查询）")
            print("使用示例：")
            print("  from utils.qualification_query import query_qualification_work_order")
            print("  result = await query_qualification_work_order(page, '20051875589', '100000041462041')")
